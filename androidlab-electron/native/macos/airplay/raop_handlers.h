...
#include "dnssdint.h"
#include "utils.h"
#include "ap_config.h" /* AndroidLab: configurable advertised display resolution */
#include <ctype.h>
#include <stdlib.h>
                  ...
                  char **response_data, int *response_datalen)
{
    ...
    plist_t displays_0_width_node = plist_new_uint(ap_display_width);
    plist_t displays_0_height_node = plist_new_uint(ap_display_height);
    plist_t displays_0_width_pixels_node = plist_new_uint(ap_display_width);
    plist_t displays_0_height_pixels_node = plist_new_uint(ap_display_height);
