 ...
 * <userData>/filter_presets.json — and because main sets the app name to
 * "AndroidLab", that path matches the Python app's app-support dir, so an
 * existing filter_presets.json is read back unchanged.
 */
